...
# Key phrase unique to file names used for each plot type. (Copy to update_plots.py if modified)
...
"""
# ^menu.js and browser_loader.js need to be executed afer JQuery finishes loading in order to work properly
...
file.close()
print(f'\tCreated file tree for {plot_type}.')
